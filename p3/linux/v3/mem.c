...
int Mem_Init(int sizeOfRegion)
{
	...
	//float num_pages = (float)(sizeOfRegion / page_size);
	//int round_size = (int) ceil (num_pages);
...
/*	
	int page_size = getpagesize();
	int page_div = (int) (sizeOfRegion / page_size);

	if(!page_div)
		round_size = page_size;
	else 
		round_size = (int) (sizeOfRegion % getpagesize());
*/
